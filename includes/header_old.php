                        ...
                        <nav class="top-login" aria-label="horizontal-nav">
                                ...
                                ?>
                                        ...
                                        <span class="button button-secondary">
                                                <a href="<?= $CLIENT_ROOT . "/profile/index.php?refurl=" . htmlspecialchars($_SERVER['SCRIPT_NAME'], ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . "?" . htmlspecialchar$
                                                        <?= $LANG['H_LOGIN'] ?>
                                                </a>
                                        </span>
                                        <?php
				...
				<ul class="menu">
					...
					<li>
						<a href="<?= $CLIENT_ROOT; ?>/collections/index.php">
							<?= $LANG['H_SEARCH_COLLECTIONS'] ?>
						</a>
					</li>
					<li>
						<a href="<?= $CLIENT_ROOT; ?>/collections/map/index.php" target="_blank" rel="noopener noreferrer">
							<?= $LANG['H_MAP_SEARCH'] ?>
						</a>
					</li>
					<li>
